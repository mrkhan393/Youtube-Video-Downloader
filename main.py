...
# Browse Button
browse = tk.Button(window, text="Browse",command=browse_location,fg='black'  ,bg="gray"  ,width=11 ,height=1 , activebackground = "Red" ,font=('times', 15, ' bold '))
browse.place(x=600, y=270)

# Decision Buttons
clearButton = tk.Button(window, text="Clear",command=clear,fg="black" ,bg="gray" ,width=10 ,height=2 , activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton.place(x=180, y=350)

down = tk.Button(window, text="Download",command=download_file,fg="black" ,bg="gray" ,width=10 ,height=2, activebackground = "Red" ,font=('times', 15, ' bold '))
